...
Upgrading from 2.x is a read of [`MIGRATION.md`](./MIGRATION.md) — every removal, rename and behaviour change is listed there, with the replacement for each one. It is also on the site as the [migration guide](https://sdk.d-id.com/documents/Migration_guide.html).
